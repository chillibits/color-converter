...
public class ColorSelectionActivity extends AppCompatActivity {
    ...
    private RecyclerView.LayoutManager colors_view_manager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        colors_view_manager = new LinearLayoutManager(this);
        colors_view.setLayoutManager(colors_view_manager);
        colors_view_adapter = new ColorsAdapter(res, colors);
